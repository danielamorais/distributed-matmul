...
# sns.lineplot(data=stats_history, x='order', y='Requests/s')
# plt.title('Requests/s Dana')
# plt.show()
...
# sns.lineplot(data=stats_history_serial, x='order', y='Requests/s')
# plt.title('Requests/s Flask')
# plt.show()
