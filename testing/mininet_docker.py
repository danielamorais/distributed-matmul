...
def create_network():
    ...
    remote1 = net.addHost('remote1', cls=Docker, ip='10.0.0.2', dimage="distributed-matmul-dana-remote-1")
    remote2 = net.addHost('remote2', cls=Docker, ip='10.0.0.3', dimage="distributed-matmul-dana-remote-2")
    # locust = net.addHost('locust', cls=Docker, ip='10.0.0.4', dimage="distributed-matmul-locust-test")
    # serial = net.addHost('serial', cls=Docker, ip='10.0.0.5', dimage="distributed-matmul-serial-matmul")
    ...
    net.addLink(dana_main, s1, bw=10, delay='6ms', loss=1, r2q=500)
    net.addLink(remote1, s1, bw=5, delay='1ms', loss=2, r2q=500)
    net.addLink(remote2, s1, bw=5, delay='1ms', loss=2, r2q=500)
