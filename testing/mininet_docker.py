...
def create_network():
    ...
    net.addLink(remote1, s1, bw=5, delay='1ms', loss=2, r2q=500)  # Nome corrigido: remote1
    net.addLink(remote2, s1, bw=5, delay='1ms', loss=2, r2q=500)  # Nome corrigido: remote2
