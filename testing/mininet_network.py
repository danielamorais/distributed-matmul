...
def test_network():
    ...
    locust = net.addHost('locust', ip='10.5.0.5/16')

    switch2 = net.addSwitch('s2')
    serial = net.addHost('serial', ip='10.5.0.6/16')
    locusts = net.addHost('locusts', ip='10.5.0.7/16')

    net.addLink(dana, switch, delay="1ms")
    net.addLink(remote1, switch, delay="1ms")
    net.addLink(remote2, switch, delay="1ms")
    net.addLink(locust, switch, delay="6ms")
    ...
    locust.cmd("locust -f testing/locustfile.py --headless -u 500 -r 50 -H http://10.5.0.2:8080 --run-time 5m --csv results/dana &")
    locusts.cmd("locust -f testing/locustfile_serial.py --headless -u 500 -r 50 -H http://10.5.0.6:5000 --run-time 5m --csv results/serial &")
